...
public class News
{
    ...
    [JsonPropertyName("published_utc")] public DateTimeOffset PublishedUtc { get; set; }

    [JsonPropertyName("article_url")] public Uri ArticleUrl { get; set; }

    [JsonPropertyName("tickers")] public string[] Tickers { get; set; }

    [JsonPropertyName("amp_url")] public Uri AmpUrl { get; set; }
